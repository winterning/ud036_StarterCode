...
#ALGORITHM: The Hacker movie :movie title,poster_image_url,trailer_youtube_url
...
#THE MARS UNDERGROUND movie :movie title,poster_image_url,trailer_youtube_url
